...
static char* _strptime(const char* buf, const char* fmt, struct tm* tm) {
    char c;
    const char* bp;
    size_t len = 0;
    ...
    again:
        ...
        case 'c': /* Date and time, using the locale's format. */
            LEGAL_ALT(ALT_E);
            if (!(bp = _strptime(bp, "%x %X", tm))) return (0);
            break;

        case 'D': /* The date as "%m/%d/%y". */
            LEGAL_ALT(0);
            if (!(bp = _strptime(bp, "%m/%d/%y", tm))) return (0);
            break;

        case 'R': /* The time as "%H:%M". */
            LEGAL_ALT(0);
            if (!(bp = _strptime(bp, "%H:%M", tm))) return (0);
            break;

        case 'r': /* The time in 12-hour clock representation. */
            LEGAL_ALT(0);
            if (!(bp = _strptime(bp, "%I:%M:%S %p", tm))) return (0);
            break;

        case 'T': /* The time as "%H:%M:%S". */
            LEGAL_ALT(0);
            if (!(bp = _strptime(bp, "%H:%M:%S", tm))) return (0);
            break;
...
unsigned long date2timestamp(const char* fmt_date, const char* date) {
    ...
    _strptime(date, fmt_date, &tmp_time);
